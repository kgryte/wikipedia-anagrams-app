...
*
*	DESCRIPTION:
*		- Determines the run-time application environment and corresponding configuration.
*
*
*	NOTES:
*		[1]
...
function config() {
	...
	if ( fs.existsSync( filepath ) ) {
		// TODO: merge the config file into the CONFIG object.
		conf = require( filepath );
		CONFIG.logger.level = conf.logger.level;
	}
} // end FUNCTION config()
...
*
* @param {String} [keypath] - key path (NOTE: nested keys should be dot delimited; e.g., 'ssl.enabled'. )
...
Config.prototype.merge = function( config ) {
	console.log( config );
	// TODO: utility which merges to create a new CONFIG. Do not want shared (leaky) references.
}; // end METHOD merge()
